	...
	public Map<String, String> getBodySampleMapping() {
		if (bodySampleMapping == null) {
			...
			bodySampleMapping.put("pk_productserial",
					"C_PROJ_LOGIN_SAMPLE.product_series");// 产品系列
			bodySampleMapping.put("pk_enterprisestandard",
					"C_PROJ_LOGIN_SAMPLE.product_standard");// 企业标准
			bodySampleMapping.put("typeno", "C_PROJ_LOGIN_SAMPLE.prodname");// 规格型号
			bodySampleMapping.put("pk_productspec",
					"C_PROJ_LOGIN_SAMPLE.production_spec");// 规格号
			bodySampleMapping.put("pk_structuretype",
					"C_PROJ_LOGIN_SAMPLE.structure_type");// 结构类型
			bodySampleMapping.put("contacttype",
					"C_PROJ_LOGIN_SAMPLE.contact_type");// 触点类型
			bodySampleMapping.put("quantity",
					"C_PROJ_LOGIN_SAMPLE.sample_quantity");// 样品数量
			bodySampleMapping.put("manufacturer",
					"C_PROJ_LOGIN_SAMPLE.manufacturer");// 制造商
			bodySampleMapping.put("pk_contactbrand",
					"C_PROJ_LOGIN_SAMPLE.contact_brand");// 触点牌号
			bodySampleMapping.put("contactmodel",
					"C_PROJ_LOGIN_SAMPLE.contact_model");// 触点型号
			bodySampleMapping.put("productstage",
					"C_PROJ_LOGIN_SAMPLE.product_stage");// 温度
			bodySampleMapping.put("pk_samplegroup",
					"C_PROJ_LOGIN_SAMPLE.sample_group");// 样品组别
