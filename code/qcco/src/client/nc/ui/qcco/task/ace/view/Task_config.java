...
public class Task_config extends AbstractJavaBeanDefinition {
	...
	private List getManagedList1() {
		...
		list.add(getBodyPasteToTailAction_1547248());
		list.add(getBodyLineEditAction_11af887());
		return list;
	}
	...
	public nc.ui.pubapp.uif2app.view.ShowUpableBillListView getListView() {
		...
		bean.setTemplateContainer(getTemplateContainer());
		bean.setNodekey("bt");
		bean.setUserdefitemListPreparator(getCompositeBillListDataPrepare_1b27d2c());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private List getManagedList6() {
		List list = new ArrayList();
		list.add(getUserdefQueryParam_1381118());
		list.add(getUserdefQueryParam_1ea7399());
		return list;
	}
	...
	public nc.ui.pubapp.uif2app.view.ShowUpableBillForm getBillFormEditor() {
		...
		bean.setUserdefitemPreparator(getCompositeBillDataPrepare_b5a751());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private List getManagedList7() {
		List list = new ArrayList();
		list.add(getTaskBodyAddLineAction_14b4aff());
		list.add(getBodyInsertLineAction_28c7b5());
		list.add(getBodyDelLineAction_14f54c6());
		list.add(getBodyCopyLineAction_146b6b6());
		list.add(getBodyPasteLineAction_185958a());
		list.add(getBodyPasteToTailAction_11cd86e());
		list.add(getBodyLineEditAction_c52baa());
		return list;
	}

	private nc.ui.qcco.task.action.TaskBodyAddLineAction getTaskBodyAddLineAction_14b4aff() {
		if (context.get("nc.ui.qcco.task.action.TaskBodyAddLineAction#14b4aff") != null)
	...
	private List getManagedList11() {
		List list = new ArrayList();
		list.add(getQueryParam_1fbe76a());
		list.add(getQueryParam_116157b());
		list.add(getQueryParam_dc64c0());
		return list;
	}
	...
	private List getManagedList12() {
		List list = new ArrayList();
		list.add(getUserdefQueryParam_15a84f9());
		list.add(getUserdefQueryParam_1d02857());
		return list;
	}
	...
	public nc.ui.uif2.TangramContainer getContainer() {
		...
		bean.setModel(getManageAppModel());
		bean.setTangramLayoutRoot(getTBNode_5bbbe0());
		bean.initUI();
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	...
	private List getManagedList13() {
		List list = new ArrayList();
		list.add(getHSNode_17bb246());
		list.add(getVSNode_1aa47fb());
		return list;
	}
	...
	private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_17bb246() {
		...
		bean.setRight(getVSNode_aad4d8());
	...
	private java.lang.String getI18nFB_de602a() {
		if (context.get("nc.ui.uif2.I18nFB#de602a") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#de602a");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#de602a", bean);
		...
		try {
			...
			context.put("nc.ui.uif2.I18nFB#de602a", product);
	...
	private java.lang.String getI18nFB_3b7e90() {
		if (context.get("nc.ui.uif2.I18nFB#3b7e90") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#3b7e90");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#3b7e90", bean);
		bean.setResDir("common");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#3b7e90", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private List getManagedList15() {
		List list = new ArrayList();
		list.add(getEventHandlerGroup_25327());
		list.add(getEventHandlerGroup_193a1d0());
		return list;
	}

	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_25327() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#25327") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#25327");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#25327", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent");
		bean.setHandler(getGrandBodyBeforeEditHandler_8b85e0());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_193a1d0() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#193a1d0") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
	...
	private List getManagedList16() {
		List list = new ArrayList();
		list.add(getEventHandlerGroup_9df837());
		list.add(getEventHandlerGroup_1c4a0f());
		list.add(getEventHandlerGroup_17d2210());
		list.add(getEventHandlerGroup_83c06());
		list.add(getEventHandlerGroup_bd1338());
		list.add(getEventHandlerGroup_ad5d8a());
		return list;
	}

	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_9df837() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#9df837") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#9df837");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#9df837", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.billform.AddEvent");
		bean.setHandler(getAceAddHandler_1647e45());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.qcco.task.ace.handler.AceAddHandler getAceAddHandler_1647e45() {
		if (context.get("nc.ui.qcco.task.ace.handler.AceAddHandler#1647e45") != null)
			return (nc.ui.qcco.task.ace.handler.AceAddHandler) context
					.get("nc.ui.qcco.task.ace.handler.AceAddHandler#1647e45");
		nc.ui.qcco.task.ace.handler.AceAddHandler bean = new nc.ui.qcco.task.ace.handler.AceAddHandler();
		context.put("nc.ui.qcco.task.ace.handler.AceAddHandler#1647e45", bean);
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}

	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_1c4a0f() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1c4a0f") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1c4a0f");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#1c4a0f", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.OrgChangedEvent");
		bean.setHandler(getAceOrgChangeHandler_112fee4());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_17d2210() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#17d2210") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_83c06() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#83c06") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#83c06");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#83c06", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent");
		bean.setHandler(getAceBodyBeforeEditHandler_477f91());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_bd1338() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#bd1338") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#bd1338");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#bd1338", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent");
		bean.setHandler(getAceHeadTailAfterEditHandler_9cb729());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private nc.ui.pubapp.uif2app.event.EventHandlerGroup getEventHandlerGroup_ad5d8a() {
		if (context.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#ad5d8a") != null)
			return (nc.ui.pubapp.uif2app.event.EventHandlerGroup) context
					.get("nc.ui.pubapp.uif2app.event.EventHandlerGroup#ad5d8a");
		nc.ui.pubapp.uif2app.event.EventHandlerGroup bean = new nc.ui.pubapp.uif2app.event.EventHandlerGroup();
		context.put("nc.ui.pubapp.uif2app.event.EventHandlerGroup#ad5d8a", bean);
		bean.setEvent("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent");
		bean.setHandler(getAceHeadTailBeforeEditHandler_138f63a());
		setBeanFacotryIfBeanFacatoryAware(bean);
		invokeInitializingBean(bean);
		return bean;
	}
	...
	private List getManagedList21() {
		List list = new ArrayList();
		list.add(getTemplateNotNullValidation_1d825f0());
		return list;
	}
	...
	public nc.funcnode.ui.action.GroupAction getPrintMenuAction() {
		...
		bean.setName(getI18nFB_1a2c506());
	...
	private java.lang.String getI18nFB_1a2c506() {
		if (context.get("nc.ui.uif2.I18nFB#1a2c506") != null)
			return (java.lang.String) context.get("nc.ui.uif2.I18nFB#1a2c506");
		nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
		context.put("&nc.ui.uif2.I18nFB#1a2c506", bean);
		bean.setResDir("common");
		...
		try {
			Object product = bean.getObject();
			context.put("nc.ui.uif2.I18nFB#1a2c506", product);
			return (java.lang.String) product;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private List getManagedList23() {
		List list = new ArrayList();
		list.add(getCardPanelLazilyLoad_1352452());
		list.add(getListPanelLazilyLoad_1e3906b());
		return list;
	}
