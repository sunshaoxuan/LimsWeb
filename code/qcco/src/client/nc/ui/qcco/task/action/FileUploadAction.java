...
import nc.ui.ambd.action.support.AMNCAction;
...
public class FileUploadAction extends  NCAction{
	...
	public void doAction(ActionEvent e)
		    throws Exception
		  {
		    ...
		    FuncSubInfo funcsubinfo = FunctionPermProfileManager.getInstance().getProfile(userCode).getFuncSubInfo(getModel().getContext().getNodeCode());
		  ...
		  {
		    return FileManageUIFactory.getFileManageDLG(getModel().getContext().getEntranceUI(), getDialogTitle(), getRootPath(), funcsubinfo, false);
		  }
		  ...
		  {
		    //return NCLangRes4VoTransl.getNCLangRes().getStrByID("ampub_0", "04501000-0303");
			  return "附件上传";
		  }
