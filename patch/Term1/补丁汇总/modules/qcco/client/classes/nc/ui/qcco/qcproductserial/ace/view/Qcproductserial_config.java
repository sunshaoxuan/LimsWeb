...
public nc.ui.qcco.qcproductserial.action.QcproductserialAddLineAction getBatchAddLineAction(){
 if(context.get("batchAddLineAction")!=null)
 return (nc.ui.qcco.qcproductserial.action.QcproductserialAddLineAction)context.get("batchAddLineAction");
  nc.ui.qcco.qcproductserial.action.QcproductserialAddLineAction bean = new nc.ui.qcco.qcproductserial.action.QcproductserialAddLineAction();
...
public nc.ui.qcco.qcproductserial.action.QcproductserialAddLineActiona getBatchAddLineActiona(){
 if(context.get("batchAddLineActiona")!=null)
 return (nc.ui.qcco.qcproductserial.action.QcproductserialAddLineActiona)context.get("batchAddLineActiona");
  nc.ui.qcco.qcproductserial.action.QcproductserialAddLineActiona bean = new nc.ui.qcco.qcproductserial.action.QcproductserialAddLineActiona();
